...
namespace API.Data.Migrations
{
    ...
    [Migration("20220421132950_accountCustomizer")]
    partial class accountCustomizer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Users.AppUserCustomization", b =>
                {
                    b.Property<int>("AppUserProfileId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppUserCustomization");
                });
            ...
            modelBuilder.Entity("API.Entities.Users.AppUserCustomization", b =>
                {
                    b.HasOne("API.Entities.Users.AppUserProfile", "AppUserProfile")
                        .WithOne("AccountCustomization")
                        .HasForeignKey("API.Entities.Users.AppUserCustomization", "AppUserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Entities.Users.AppUserProfile", b =>
                {
                    b.Navigation("AccountCustomization");
