        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.Use(async (context, next) =>
            {
                ...
                context.Response.Headers.Add("Content-Security-Policy",
                             "default-src 'self'; style-src 'self' 'unsafe-inline'; connect-src 'self' https://steamcommunity.com https://discord.com; img-src * 'self' data: https:; script-src 'self' 'unsafe-inline'");
